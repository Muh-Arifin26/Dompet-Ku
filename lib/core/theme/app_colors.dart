...
class AppColors {
  // Primary Green (Hijau Ketupat Gradient)
  static const Color primary = Color(0xFF1E8224);
  static const Color primaryLight = Color(0xFF7ED957);
  static const Color primaryDark = Color(0xFF0F5A13);
  static const Color primarySurface = Color(0xFFEAF8EB);
  static const Color primaryBorder = Color(0xFFC0EBC3);
